...
```
Two main takeaways from the figure: one, that the average magnitude of delays is generally the same over the day, whether it be for subways or buses, and two, that the average delay time for buses is around 4-5 times more than that of subways. This confirms the intuition that subways generally are a more time-reliable way to get somewhere than buses, and we will therefore focus on subways from hereonwards in our quest for the most reliable transit plan.
